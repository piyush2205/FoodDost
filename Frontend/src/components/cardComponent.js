...
const CardComponent = memo(({ ...el }) => {
    ...
    return (
        ...
        <>
            ...
            <div className=" border-2 shadow-xl  shadow-outline rounded-3xl">
                <figure className='w-full'><img className='w-full' src="https://th.bing.com/th/id/OIP.QuUTQeb-TCUWgMOu27vgRAHaE7?w=262&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="Shoes" /></figure>
                <div className="p-4" >
