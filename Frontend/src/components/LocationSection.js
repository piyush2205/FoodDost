        ...
        <>
            <div className='bg-black w-screen   bg-cover  p-10  sm:h-[376px] sm:w-auto  md:w-auto lg:w-full '>
                ...
                <div className='flex content-center place-content-center my-2.5 gap-4  '>
                    <Link to="/Gorakhpur">
                        <div className='w-96 text-center bg-white-400 h-24 shadow-lg  shadow-outline border content-center place-content-center'>
                    ...
                    {/* <Link to="/Gorakhpur">
                        <div className='w-96 text-center bg-white-400 h-24 shadow-lg  shadow-outline border content-center place-content-center'>
                            ...
                            <h1 className='font-semibold text-6xl antialiased text-center my-3  text-[#fff]'>Dehradoon</h1>
                    ...
                    <Link to="/Gorakhpur">
                        <div className='w-96 text-center bg-white-400 h-24 shadow-lg  shadow-outline border content-center place-content-center'>
                            ...
                            <h1 className='font-semibold text-6xl antialiased text-center my-3  text-[#fff]'>Noida</h1>
