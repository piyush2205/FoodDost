...
function AllRouter() {
    ...
    return (
        <>
            ...
            <Suspense fallback={
                <div role="status" className='flex justify-center items-center mt-[40vh]'>
                    <svg aria-hidden="true" class="w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-[#ED4949]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
